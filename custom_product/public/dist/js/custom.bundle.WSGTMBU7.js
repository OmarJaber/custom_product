(() => {
  // ../custom_product/custom_product/public/js/init.js
  if (!window.webshop)
    window.webshop = {};
  if (!frappe.boot)
    frappe.boot = {};

  // ../custom_product/custom_product/public/js/customer_reviews.js
  $(() => {
  ...
  // ../custom_product/custom_product/public/js/product_ui/grid.js
  webshop.ProductGrid = class {
    ...
    get_primary_button(item, settings) {
      if (item.has_variants) {
        ...
        const user_language = frappe.boot.lang;
        const add_to_cart = user_language === "ar" ? "\u0623\u0636\u0641 \u0625\u0644\u0649 \u0627\u0644\u0633\u0644\u0629" : __("Add to Cart");
        const add_to_quote = user_language === "ar" ? "\u0623\u0636\u0641 \u0625\u0644\u0649 \u0639\u0631\u0636 \u0627\u0644\u0633\u0639\u0631" : __("Add to Quote");
        const go_to_cart = user_language === "ar" ? "\u0627\u0630\u0647\u0628 \u0625\u0644\u0649 \u0627\u0644\u0633\u0644\u0629" : __("Go to Cart");
        const go_to_quote = user_language === "ar" ? "\u0625\u0630\u0647\u0628 \u0625\u0644\u0649 \u0639\u0631\u0636 \u0627\u0644\u0633\u0639\u0631" : __("Go to Quote");
        return `
				<div id="${item.name}" class="btn
					...
					${settings.enable_checkout ? __(add_to_cart) : __(add_to_quote)}
				</div>
				...
				<a href="/cart">
					<div id="${item.name}" class="btn
						...
						${item.in_cart ? "" : "hidden"}"
						data-item-code="${item.item_code}">
						${settings.enable_checkout ? __(go_to_cart) : __(go_to_quote)}
					</div>
				</a>
			`;
      } else {
  ...
  // ../custom_product/custom_product/public/js/product_ui/list.js
  ...
  // ../custom_product/custom_product/public/js/product_ui/search.js
  ...
  // ../custom_product/custom_product/public/js/product_ui/views.js
  webshop.ProductView = class {
    ...
    prepare_search() {
      const user_language = frappe.boot.lang;
      const placeholder_text = user_language === "ar" ? "\u0627\u0628\u062D\u062B \u0639\u0646 \u0627\u0644\u0645\u0646\u062A\u062C\u0627\u062A" : __("Search for Products");
      $(".toolbar").append(`
  ...
  // ../custom_product/custom_product/public/js/shopping_cart.js
  ...
  // ../custom_product/custom_product/public/js/wishlist.js
...
//# sourceMappingURL=custom.bundle.WSGTMBU7.js.map
